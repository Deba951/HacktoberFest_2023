...
<img src="https://img.shields.io/github/issues-pr/ossamamehmood/hacktoberfest2023" alt="Pull Requests Badge"/>
<img alt="GitHub contributors" src="https://img.shields.io/github/contributors/ossamamehmood/hacktoberfest2023?color=2b9348">
...
#### :three: Add a remote (upstream) to the original project repository:
...
## Creating a PR :scream: :scream: :scream: :scream: :
 ...
 #### :small_red_triangle: After making changes or modifications to your code locally, you need to add these files to the staging area.
```
  $ git add --all
```
 #### :small_red_triangle: Once files are added, you need to commit the changes with an appropriate commit message.
```
